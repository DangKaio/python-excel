...
def readExcelDataByName(filename, sheetName, num,save_filename):
    ...
    # alignment.vert = xlwt.Alignment.VERT_TOP # 可取值: VERT_TOP, VERT_CENTER, VERT_BOTTOM, VERT_JUSTIFIED, VERT_DISTRIBUTED
    # style = xlwt.XFStyle() # 创建样式
    # style.alignment = alignment # 给样式添加文字居中属性
    # style.font.height=430 #设置字体大小
    # #----------设置列宽高--------------
    # col1=sheet1.col(num) #获取第0列
...
if __name__ == '__main__':
    ...
    """
    readExcelDataByName('F:\\项目\\华润三九\\华润三九测试用例-6.7.xlsx', '代表小程序初版', 7,"F:\\项目\\华润三九\\分隔结果文档")
